...
@endif
<p>
  @include('admin-client/area/tambah')
</p>
<form action="{{ asset('admin-client/area/proses') }}" method="post" accept-charset="utf-8">
{{ csrf_field() }}
<div class="row">
...
<tbody>
    ...
    <td>
        <div class="btn-group">
        <a href="{{ asset('admin-client/area/edit/'.$ar->id) }}" 
          class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>

          <a href="{{ asset('admin-client/area/delete/'.$ar->id) }}" class="btn btn-danger btn-sm  delete-link">
