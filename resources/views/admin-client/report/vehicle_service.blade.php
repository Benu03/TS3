...
<thead>
    <tr class="bg-info">
        ...
        <th width="15%">Nomor Mesin</th>   
        <th width="15%">Nomor Rangka</th>  
        <th width="15%">PIC Service Last</th>  
        <th width="15%">Bengkel Service Last</th>  
        <th width="15%">Last Date Service</th> 
