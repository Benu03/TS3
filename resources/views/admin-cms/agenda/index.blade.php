...
<div class="row">
  ...
  <div class="col-md-6">
    <form action="{{ asset('admin-cms/agenda/cari') }}" method="get" accept-charset="utf-8">
      {{ csrf_field() }}
    <div class="input-group">                  
      ...
      <span class="input-group-btn btn-flat">
        ...
        <?php if(Request::segment(3)=="jenis_agenda") { ?>
          <a href="{{ asset('admin-cms/agenda/tambah?jenis_agenda='.Request::segment(4)) }}" class="btn btn-success">
          <i class="fa fa-plus"></i> Tambah Baru</a>
        <?php }else{ ?>
          <a href="{{ asset('admin-cms/agenda/tambah') }}" class="btn btn-success">
          <i class="fa fa-plus"></i> Tambah Baru</a>
        <?php } ?>
      </span>
    </div>
...
<tr>
    ...
    <td>
    <a href="{{ asset('admin-cms/agenda/edit/'.$agenda->id_agenda) }}">
    ...
    <td>
    <a href="{{ asset('admin-cms/agenda/kategori_agenda/'.$agenda->id_kategori_agenda) }}">
    <?php echo $agenda->nama_kategori_agenda ?><sup><i class="fa fa-link"></i></sup>
    </a>
    <br>
    Jenis: <a href="{{ asset('admin-cms/agenda/jenis_agenda/'.$agenda->jenis_agenda) }}">
    <?php echo $agenda->jenis_agenda ?><sup><i class="fa fa-link"></i></sup>
    </a></td>
    <td><a href="{{ asset('admin-cms/agenda/status_agenda/'.$agenda->status_agenda) }}">
    ...
    <td>
    <a href="{{ asset('admin-cms/agenda/author/'.$agenda->id_user) }}">
    ...
    <td>
      <div class="btn-group">
        ...
        <a href="{{ asset('admin-cms/agenda/delete/'.$agenda->id_agenda) }}" class="btn btn-danger btn-sm delete-link"><i class="fas fa-trash-alt"></i></a>
      </div>
    </td>
</tr>
