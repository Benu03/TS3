<p class="text-right">
  <a href="{{ asset('admin-cms/agenda') }}" class="btn btn-success btn-sm">
...
<form action="{{ asset('admin-cms/agenda/tambah_proses') }}" method="post" enctype="multipart/form-data" accept-charset="utf-8">
{{ csrf_field() }}
