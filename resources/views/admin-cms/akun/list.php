<div class="row">
	<div class="col-md-7">
		...
		<?php echo form_open_multipart(base_url('admin-cms/akun'),'id="tambah"') ?>
		...
		<div class="form-group row">
			...
			<div class="col-sm-9">
				<div class="form-group btn-group text-right">
					...
					<a href="<?php echo base_url('admin-cms/dasbor') ?>" class="btn btn-secondary " data-dismiss="modal"><i class="fa fa-times"></i> Kembali</a>
				</div>
			</div>
		</div>
	...
	<div class="col-md-5">
		...
		<?php echo form_open_multipart(base_url('admin-cms/akun/password'),'id="tambah"') ?>
