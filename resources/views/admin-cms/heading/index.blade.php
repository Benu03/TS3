<p>
@include('admin-cms/heading/tambah')
</p>
...
<tr>
    ...
    <i class="fa fa-edit"></i>
      ...
      <a href="{{ asset('admin-cms/heading/delete/'.$heading->id_heading) }}" class="btn btn-danger btn-sm delete-link"><i class="fas fa-trash-alt"></i></a>
      </div>
      @include('admin-cms/heading/edit')
    </td>
</tr>
