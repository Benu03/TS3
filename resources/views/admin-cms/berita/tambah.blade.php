<p class="text-right">
  <a href="{{ asset('admin-cms/berita') }}" class="btn btn-success btn-sm">
...
<form action="{{ asset('admin-cms/berita/tambah_proses') }}" method="post" enctype="multipart/form-data" accept-charset="utf-8">
{{ csrf_field() }}
