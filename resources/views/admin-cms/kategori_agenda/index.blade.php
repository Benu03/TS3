<p>
@include('admin-cms/kategori_agenda/tambah')
</p>
...
<tr>
    ...
    <i class="fa fa-edit"></i> Edit
      ...
      <a href="{{ asset('admin-cms/kategori_agenda/delete/'.$kategori_agenda->id_kategori_agenda) }}" class="btn btn-danger btn-sm delete-link"><i class="fas fa-trash-alt"></i> Hapus</a>
      </div>
      @include('admin-cms/kategori_agenda/edit')
    </td>
</tr>
