<p>
@include('admin-cms/kategori_staff/tambah')
</p>
...
<tr>
    ...
    <i class="fa fa-edit"></i> Edit
      ...
      <a href="{{ asset('admin-cms/kategori_staff/delete/'.$kategori_staff->id_kategori_staff) }}" class="btn btn-danger btn-sm delete-link"><i class="fas fa-trash-alt"></i> Hapus</a>
      </div>
      @include('admin-cms/kategori_staff/edit')
    </td>
</tr>
