...
<div class="row">
  ...
  <div class="col-md-6">
    <form action="{{ asset('admin-ts3/berita/cari') }}" method="get" accept-charset="utf-8">
      {{ csrf_field() }}
    <div class="input-group">                  
      ...
      <span class="input-group-btn btn-flat">
        ...
        <?php if(Request::segment(3)=="jenis_berita") { ?>
          <a href="{{ asset('admin-ts3/berita/tambah?jenis_berita='.Request::segment(4)) }}" class="btn btn-success">
          <i class="fa fa-plus"></i> Tambah Baru</a>
        <?php }else{ ?>
          <a href="{{ asset('admin-ts3/berita/tambah') }}" class="btn btn-success">
          <i class="fa fa-plus"></i> Tambah Baru</a>
        <?php } ?>
      </span>
    </div>
...
<form action="{{ asset('admin-ts3/berita/proses') }}" method="post" accept-charset="utf-8">
...
<tr>
    ...
    <td>
    <a href="{{ asset('admin-ts3/berita/edit/'.$berita->id_berita) }}">
    <?php echo $berita->judul_berita ?> <sup><i class="fa fa-pencil"></i></sup>
      ...
      <small>
        ...
        <br>Jenis: <a href="{{ asset('admin-ts3/berita/jenis_berita/'.$berita->jenis_berita) }}">
  ...
  <?php if(Request::segment(3)=="jenis_berita") {}else{ ?>
    <td>
    <a href="{{ asset('admin-ts3/berita/kategori/'.$berita->id_kategori) }}">
    <?php echo $berita->nama_kategori ?><sup><i class="fa fa-link"></i></sup>
    </a>
    </td>
  <?php } ?>
    <td><a href="{{ asset('admin-ts3/berita/status_berita/'.$berita->status_berita) }}">
    ...
    <a href="{{ asset('admin-ts3/berita/author/'.$berita->id_user) }}">
  ...
  <?php } ?>
    ...
    <td>
      <div class="btn-group">
        ...
        <a href="{{ asset('admin-ts3/berita/delete/'.$berita->id_berita.'/'.$berita->jenis_berita) }}" class="btn btn-danger btn-sm delete-link"><i class="fas fa-trash-alt"></i></a>
      </div>
    </td>
</tr>
