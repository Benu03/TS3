<p>
@include('admin-ts3/heading/tambah')
</p>
...
<tr>
    ...
    <i class="fa fa-edit"></i>
      ...
      <a href="{{ asset('admin-ts3/heading/delete/'.$heading->id_heading) }}" class="btn btn-danger btn-sm delete-link"><i class="fas fa-trash-alt"></i></a>
      </div>
      @include('admin-ts3/heading/edit')
    </td>
</tr>
