...
<form action="{{ asset('admin-ts3/heading/edit') }}" enctype="multipart/form-data"  method="post" accept-charset="utf-8">
{{ csrf_field() }}
...
<div class="form-group row">
	...
	<div class="col-md-9">
		<select name="halaman" class="form-control">
			...
			<option value="About" <?php if($heading->halaman=="About") { echo 'selected'; } ?>>About</option>
