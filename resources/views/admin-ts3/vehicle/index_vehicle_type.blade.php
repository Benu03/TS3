...
<td>
    <div class="btn-group">
    <a href="{{ asset('admin-ts3/vehicle-type/edit-vehicle-type/'.$vt->id) }}" 
    class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>

    <a href="{{ asset('admin-ts3/vehicle-type/delete-vehicle-type/'.$vt->id) }}" class="btn btn-danger btn-sm  delete-link">
