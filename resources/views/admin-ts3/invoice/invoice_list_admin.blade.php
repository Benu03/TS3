<div class="row">
    <div class="col-md-12">      
        ...
        <div class="card">
            <div class="card-body">
                <table class="table table-bordered table-md" style="font-size: 12px;">
                    <thead>
                        <tr class="bg-info">                                                      
                     ...
                     <tbody>
                        ...
                        $invoicedetail  = DB::connection('ts3')->table('mvm.v_invoice_detail_admin')->where('invoice_no',$invoice_no)->get();
                        ?>
