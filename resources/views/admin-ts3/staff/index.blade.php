...
<div class="row">
  ...
  <div class="col-md-6">
    <form action="{{ asset('admin-ts3/staff/cari') }}" method="get" accept-charset="utf-8">
    <br>
    <div class="input-group">                  
      ...
      <span class="input-group-btn btn-flat">
        ...
        <a href="{{ asset('admin-ts3/staff/tambah') }}" class="btn btn-success">
...
<form action="{{ asset('admin-ts3/staff/proses') }}" method="post" accept-charset="utf-8">
  {{ csrf_field() }}
<div class="row">
  <div class="col-md-4">
    <div class="input-group">
        ...
        <tbody>
          ...
          <?php $i=1; foreach($staff as $staff) { ?>
            ...
            <tr class="odd gradeX">
              ...
              <td><a href="{{ asset('admin-ts3/staff/kategori/'.$staff->id_kategori_staff) }}"><?php echo $staff->nama_kategori_staff ?></a></td>
              <td><a href="{{ asset('admin-ts3/staff/status_staff/'.$staff->status_staff) }}">
                  <?php echo $staff->status_staff ?></a></td>
              <td><?php echo $staff->urutan ?></td>
              <td><div class="btn-group">
                  <a href="{{ asset('admin-ts3/staff/detail/'.$staff->id_staff) }}" 
                    class="btn btn-success btn-sm"><i class="fa fa-eye"></i> Detail</a>
                  <a href="{{ asset('admin-ts3/staff/edit/'.$staff->id_staff) }}" 
                    class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
                    <a href="{{ asset('admin-ts3/staff/delete/'.$staff->id_staff) }}" class="btn btn-danger btn-sm delete-link"><i class="fa fa-trash"></i></a>
                  </div>
                </td>
              </tr>
                    <?php $i++; } ?>
