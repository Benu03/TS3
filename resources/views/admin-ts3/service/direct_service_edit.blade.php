...
<form action="{{ asset('admin-ts3/direct-service-edit-proses') }}" enctype="multipart/form-data" method="post" accept-charset="utf-8">
{{ csrf_field() }}
<input type="hidden" name="id" value="<?php echo $direct->id ?>">
				...
				<div class="form-group row">
					...
					<div class="col-sm-9">
						<textarea name="remark_ts3" class="form-control" id="remark_ts3" placeholder="Remark"><?php echo $direct->remark_ts3 ?></textarea>
