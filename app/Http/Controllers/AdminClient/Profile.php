...
class Profile extends Controller
{
    ...
    public function index()
    {
		...
		$data = array(  'title'     => 'Profile',
                        'user'     =>  $user,
                        'user_m'     => $user_m,
                        'content'   => 'admin-client/dasbor/profile'
                    );
    ...
    public function ubah_password(Request $request)
    {
        ...
        if($request->password1 <> $request->password2){
            ...
            return redirect('admin-client/profile')->with(['warning' => 'Password Tidak sama']);
        }
        else
        {
        ...
        return redirect('admin-client/profile')->with(['sukses' => 'Password berhasil Di Update']);  
        }
