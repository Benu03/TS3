...
class Staff extends Controller
{
    ...
    public function detail($id_staff)
    {
        ...
        $data = array(  'title'             => $staff->nama_staff,
                        'staff'             => $staff,
                        'content'           => 'admin-ts3/staff/detail'
                    );
        return view('admin-ts3/layout/wrapper',$data);
    }
    ...
    public function proses(Request $request)
    {
        ...
        if(isset($_POST['hapus'])) {
            ...
            return redirect('admin-ts3/staff')->with(['sukses' => 'Data telah dihapus']);
        // PROSES SETTING DRAFT
            ...
            return redirect('admin-ts3/staff')->with(['sukses' => 'Data kategori telah diubah']);
        }
    }
    ...
    public function tambah()
    {
        ...
        $data = array(  'title'             => 'Tambah Staff (Board and Team)',
                        'kategori_staff'   => $kategori_staff,
                        'content'           => 'admin-ts3/staff/tambah'
                    );
        return view('admin-ts3/layout/wrapper',$data);
    }
    ...
    public function tambah_proses(Request $request)
    {
        ...
        return redirect('admin-ts3/staff')->with(['sukses' => 'Data telah ditambah']);
    }
