...
class Galeri extends Controller
{
    ...
    public function index()
    {
		...
		$data = array(  'title'				=> 'Data Galeri',
                        ...
                        'content'			=> 'admin-ts3/galeri/index'
                    );
    ...
    public function proses(Request $request)
    {
        ...
        if(isset($_POST['hapus'])) {
            ...
            return redirect('admin-ts3/galeri')->with(['sukses' => 'Data telah dihapus']);
        // PROSES SETTING DRAFT
            ...
            return redirect('admin-ts3/galeri')->with(['sukses' => 'Data kategori telah diubah']);
        }
    }
    ...
    public function tambah()
    {
        ...
        $data = array(  'title'             => 'Tambah Galeri',
                        'kategori_galeri'   => $kategori_galeri,
                        'content'           => 'admin-ts3/galeri/tambah'
                    );
        return view('admin-ts3/layout/wrapper',$data);
    }
    ...
    public function tambah_proses(Request $request)
    {
        ...
        return redirect('admin-ts3/galeri')->with(['sukses' => 'Data telah ditambah']);
    }
