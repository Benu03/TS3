...
class Konfigurasi extends Controller
{
    ...
    public function index()
    {
		...
		$data = array(  'title'        => 'Data Konfigurasi',
						'site'         => $site,
                        'content'      => 'admin-ts3/konfigurasi/index'
                    );
    ...
    public function logo()
    {
        ...
        $data = array(  'title'        => 'Update Logo',
                        'site'         => $site,
                        'content'      => 'admin-ts3/konfigurasi/logo'
                    );
        return view('admin-ts3/layout/wrapper',$data);
    }
    ...
    public function profil()
    {
        ...
        $data = array(  'title'        => 'Profil '.$site->namaweb,
                        'site'         => $site,
                        'content'      => 'admin-ts3/konfigurasi/profil'
                    );
        return view('admin-ts3/layout/wrapper',$data);
    }
    ...
    public function gambar()
    {
        ...
        $data = array(  'title'        => 'Update Gambar Banner',
                        'site'         => $site,
                        'content'      => 'admin-ts3/konfigurasi/gambar'
                    );
        return view('admin-ts3/layout/wrapper',$data);
    }
    ...
    public function icon()
    {
        ...
        $data = array(  'title'        => 'Update Icon',
                        'site'         => $site,
                        'content'      => 'admin-ts3/konfigurasi/icon'
                    );
        return view('admin-ts3/layout/wrapper',$data);
    }
    ...
    public function email()
    {
        ...
        $data = array(  'title'        => 'Update Setting Email',
                        'site'         => $site,
                        'content'      => 'admin-ts3/konfigurasi/email'
                    );
        return view('admin-ts3/layout/wrapper',$data);
    }
    ...
    public function pembayaran()
    {
        ...
        $data = array(  'title'        => 'Update Panduan Pembayaran',
                        'site'         => $site,
                        'content'      => 'admin-ts3/konfigurasi/pembayaran'
                    );
        return view('admin-ts3/layout/wrapper',$data);
    }
    ...
    public function proses(Request $request)
    {
        ...
        return redirect('admin-ts3/konfigurasi')->with(['sukses' => 'Data telah diupdate']);
    }
    ...
    public function proses_email(Request $request)
    {
        ...
        return redirect('admin-ts3/konfigurasi/email')->with(['sukses' => 'Data setting email telah diupdate']);
    }
    ...
    public function proses_logo(Request $request)
    {
        ...
        return redirect('admin-ts3/konfigurasi/logo')->with(['sukses' => 'Logo telah diupdate']);
    }
    ...
    public function proses_profil(Request $request)
    {
        ...
        return redirect('admin-ts3/konfigurasi/profil')->with(['sukses' => 'Logo telah diupdate']);
    }
    ...
    public function proses_icon(Request $request)
    {
        ...
        return redirect('admin-ts3/konfigurasi/icon')->with(['sukses' => 'Icon telah diupdate']);
    }
    ...
    public function proses_gambar(Request $request)
    {
        ...
        return redirect('admin-ts3/konfigurasi/gambar')->with(['sukses' => 'Gambar Banner telah diupdate']);
    }
    ...
    public function proses_pembayaran(Request $request)
    {
        ...
        return redirect('admin-ts3/konfigurasi/pembayaran')->with(['sukses' => 'Data metode pembayaran telah diupdate']);
    }
}
