...
class Kategori_staff extends Controller
{
    ...
    public function index()
    {
		...
		$data = array(  'title'             => 'Kategori Staff',
                        ...
                        'content'           => 'admin-cms/kategori_staff/index'
                    );
    ...
    public function tambah(Request $request)
    {
        ...
        return redirect('admin-cms/kategori_staff')->with(['sukses' => 'Data telah ditambah']);
    }
    ...
    public function edit(Request $request)
    {
        ...
        return redirect('admin-cms/kategori_staff')->with(['sukses' => 'Data telah diupdate']);
    }
    ...
    public function delete($id_kategori_staff)
    {
    	...
    	return redirect('admin-cms/kategori_staff')->with(['sukses' => 'Data telah dihapus']);
    }
}
