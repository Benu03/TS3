...
class Heading extends Controller
{
    ...
    public function index()
    {
		...
		$data = array(  'title'         => 'Setting Header',
						'heading'	    => $heading,
                        'content'       => 'admin-cms/heading/index'
                    );
    ...
    public function edit(Request $request)
    {
        ...
        return redirect('admin-cms/heading')->with(['sukses' => 'Data telah diupdate']);
    }
    ...
    public function delete($id_heading)
    {
    	...
    	return redirect('admin-cms/heading')->with(['sukses' => 'Data telah dihapus']);
    }
}
