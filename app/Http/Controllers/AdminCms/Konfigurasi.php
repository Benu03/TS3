...
class Konfigurasi extends Controller
{
    ...
    public function index()
    {
		...
		$data = array(  'title'        => 'Data Konfigurasi',
						'site'         => $site,
                        'content'      => 'admin-cms/konfigurasi/index'
                    );
    ...
    public function logo()
    {
        ...
        $data = array(  'title'        => 'Update Logo',
                        'site'         => $site,
                        'content'      => 'admin-cms/konfigurasi/logo'
                    );
        return view('admin-cms/layout/wrapper',$data);
    }
    ...
    public function profil()
    {
        ...
        $data = array(  'title'        => 'Profil '.$site->namaweb,
                        'site'         => $site,
                        'content'      => 'admin-cms/konfigurasi/profil'
                    );
        return view('admin-cms/layout/wrapper',$data);
    }
    ...
    public function gambar()
    {
        ...
        $data = array(  'title'        => 'Update Gambar Banner',
                        'site'         => $site,
                        'content'      => 'admin-cms/konfigurasi/gambar'
                    );
        return view('admin-cms/layout/wrapper',$data);
    }
    ...
    public function icon()
    {
        ...
        $data = array(  'title'        => 'Update Icon',
                        'site'         => $site,
                        'content'      => 'admin-cms/konfigurasi/icon'
                    );
        return view('admin-cms/layout/wrapper',$data);
    }
    ...
    public function email()
    {
        ...
        $data = array(  'title'        => 'Update Setting Email',
                        'site'         => $site,
                        'content'      => 'admin-cms/konfigurasi/email'
                    );
        return view('admin-cms/layout/wrapper',$data);
    }
    ...
    public function pembayaran()
    {
        ...
        $data = array(  'title'        => 'Update Panduan Pembayaran',
                        'site'         => $site,
                        'content'      => 'admin-cms/konfigurasi/pembayaran'
                    );
        return view('admin-cms/layout/wrapper',$data);
    }
    ...
    public function proses(Request $request)
    {
        ...
        request()->validate([
            ...
            DB::connection('ts3')->table('cp.konfigurasi')->where('id_konfigurasi',$request->id_konfigurasi)->update([
        ...
        return redirect('admin-cms/konfigurasi')->with(['sukses' => 'Data telah diupdate']);
    }
    ...
    public function proses_email(Request $request)
    {
        ...
        return redirect('admin-cms/konfigurasi/email')->with(['sukses' => 'Data setting email telah diupdate']);
    }
    ...
    public function proses_logo(Request $request)
    {
        ...
        return redirect('admin-cms/konfigurasi/logo')->with(['sukses' => 'Logo telah diupdate']);
    }
    ...
    public function proses_profil(Request $request)
    {
        ...
        return redirect('admin-cms/konfigurasi/profil')->with(['sukses' => 'Logo telah diupdate']);
    }
    ...
    public function proses_icon(Request $request)
    {
        ...
        return redirect('admin-cms/konfigurasi/icon')->with(['sukses' => 'Icon telah diupdate']);
    }
    ...
    public function proses_gambar(Request $request)
    {
        ...
        return redirect('admin-cms/konfigurasi/gambar')->with(['sukses' => 'Gambar Banner telah diupdate']);
    }
    ...
    public function proses_pembayaran(Request $request)
    {
        ...
        return redirect('admin-cms/konfigurasi/pembayaran')->with(['sukses' => 'Data metode pembayaran telah diupdate']);
    }
}
